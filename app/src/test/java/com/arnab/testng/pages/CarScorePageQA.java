...
public class CarScorePageQA extends PageBase {
    ...
    @AndroidFindBy(id = "com.dds.carscore.qa:id/select_features_manually_button")
    public MobileElement selectFeaturesManuallyButton;
    ...
    @AndroidFindBy(id = "com.android.permissioncontroller:id/permission_allow_foreground_only_button")
    public MobileElement recordAudioPermissionButton;

    @AndroidFindBy(id = "com.android.permissioncontroller:id/permission_allow_button")
    public MobileElement notificationPermissionAllowButton;
